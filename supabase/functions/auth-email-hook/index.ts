...
const EMAIL_SUBJECTS: Record<string, string> = {
  ...
  invite: 'Vous êtes invité à rejoindre Inkoo',
...
// Configuration
const SITE_NAME = "b2b-inkoo"
const SENDER_DOMAIN = "notify.inkoo.eu"
const ROOT_DOMAIN = "inkoo.eu"
const FROM_DOMAIN = "inkoo.eu" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://b2b-inkoo.lovable.app"
